...
url = "https://www.magicbricks.com/property-for-sale/residential-real-estate?bedroom=3&proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment&cityName=Kolkata"
...
#bronze_path = Path(r"C:\Users\KANAK\scraping\data\bronze\three_bhk_data")
#bronze_path.mkdir(parents=True, exist_ok=True)



#file_path = bronze_path / f"real_estate_raw_{timestamp}.json"
#output_file = BRONZE_DIR / "three_bhk_data" / f"real_estate_raw_{timestamp}.json"
output_dir_3bhk = Path("/app/data/bronze/three_bhk_data")
output_dir_3bhk.mkdir(parents=True, exist_ok=True)

output_file = output_dir_3bhk / f"real_estate_raw_{timestamp}.json"
